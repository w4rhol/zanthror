...
table(zanthror_testdata$zbmicat_stata)

# return vector to frame, tidyverse
zanthror_testdata %<>% 
  mutate(
    zbmicat_stata_df = zbmicat_stata(
      bmi = bmi,
      age = age_years,
      gender = gender,
      male_code = 1,
...
table(zanthror_testdata$zbmicat_stata_df)

zanthror_testdata %<>% 
  mutate(
    zbmicat_haven = zbmicat_stata(
    bmi = bmi,
    age = age_years,
    gender = gender,
...
```{r}
# # First, manually load the reference data from where you know it exists
# zanthro_ref_data <-  read.csv("C:/Users/warren holroyd/OneDrive - ACT Government/R/Working/zanthror/zanthro_reference_data_combined.csv", 
#                             stringsAsFactors = FALSE)
# 
# zanthror_testdata <- read.csv("C:/Users/warren holroyd/OneDrive - ACT Government/R/Working/zanthror/_build/stata/zanthror_testdata.csv", 
#                             stringsAsFactors = FALSE)

# Then test the function
zanthror_testdata$testcol = zanthro(measure = zanthror_testdata$height_cm,
